...
( function($){
	...
	ContentsController = {
			...
			switch(module){
					...
					$.ajax({
						...
						success: function(data){
							if( data.status == 200){
								...
								$(selector + ' ul.carousel-menu').menu_cycle(ContentsController);
								ContentsController.banner(module,false,currentCatId);
							}
						}
					}).done(function(){
						//console.log(bannerImg);
						ContentsController.contents(module,currentCatId,false,bannerImg);
					});
					break;
				...
				case '#accommodation':
					$.ajax({
						...
						//console.log(bannerImg);
						ContentsController.contents(module,currentCatId,false);
					});
					break;
		...
		contents: function(module,id,all){ 
			...
			switch(module){
				case '#daily_activities':
					...
					ContentsController.banner(module,false,id);
					...
					$.ajax({
						...
						success: function(data){
							if( data.status == 200){ 
								...
								$.each(data.accomodation, function(k,v){
									if( id == v.id ){
										ContentsController.banner(module,v.img);
										var html = v.desc;
							...
							if( data.status == 200){ 
								...
								$.each(data.items, function(k,v){
									...
									dialogs += '<div data-role="page" id="'+page_id+'" data-theme="a">'
												+	'<div><a role="button" href="javascript:void(0)" data-page_id="'+page_id+'" id="close-dialog" data-transition="pop" data-direction="reverse">'
												+		'<img src="images/btns/btn_back.png">'
												+	'</a></div>'
												+ 	'<div class="spa-dialog-img"><img src="' + src+v.img + '"></div>'
												+ 	'<h2 align="center" class="title">'+v.name+'</h2>'
												+ 	'<p align="center">Quantity</p>'
												+ 	'<div align="center" class="qty">'
												+ 		'<span><a href="javascript:void(0);" data-page_id="'+page_id+'" data-price="'+v.price+'" class="minus-qty"><img src="images/btns/btn_minus.png"></a></span>' 
												+ 		'<span id="'+page_id+'_qty" class="qty_handler">1</span>'
												+ 		'<span><a href="javascript:void(0);" data-page_id="'+page_id+'" data-price="'+v.price+'" class="add-qty"><img src="images/btns/btn_plus.png"></a></span>'
												+ 	'</div>'
												...
												+			'<img src="images/btns/btn_add_to_cart.png">'
												+		'</a>'
												+	'</div>'
							...
							if( data.status == 200){ 
								...
								$.each(data.laundries, function(k,v){
									...
									dialogs += '<div data-role="page" id="'+page_id+'" data-theme="a">'
												...
												+ 	'<p align="center">Quantity</p>'
												+ 	'<div align="center" class="qty">'
												+ 		'<span><a href="javascript:void(0);" data-page_id="'+page_id+'" data-price="'+price+'" class="minus-qty"><img src="images/btns/btn_minus.png"></a></span>' 
												+ 		'<span id="'+page_id+'_qty" class="qty_handler">1</span>'
												+ 		'<span><a href="javascript:void(0);" data-page_id="'+page_id+'" data-price="'+price+'" class="add-qty"><img src="images/btns/btn_plus.png"></a></span>'
												+ 	'</div>'
		...
		daily_activities: function(){
			ContentsController.menuCarousel('#daily_activities','get_activities_cat.php');
		},
		accommodation: function(){
			ContentsController.menuCarousel('#accommodation','get_accomodation.php');
		},
		facilities: function(){
			ContentsController.menuCarousel('#facilities','get_facilities.php');
		},
		spa: function(){
			ContentsController.menuCarousel('#spa','get_spa_cat.php');
		},
		souvenirs: function(){
			ContentsController.menuCarousel('#souvenirs','get_souvenirs_cat.php');
		},
		gallery: function(){
			ContentsController.menuCarousel('#hotel-gallery','get_gallery_cat.php');
		},
		hotel_map: function(){
		...
		inroomdining: function(){
			ContentsController.menuCarousel('#in-room-dining','get_inroomdining_cat.php');
		},
		az_directory: function(){
			ContentsController.menuCarousel('#az-directory','get_azdir_cat.php');
		},
		e_laundry: function(){
			ContentsController.menuCarousel('#e-laundry','get_elaundry_cat.php');
		},
		request_amenities: function(){
			ContentsController.menuCarousel('#request-amenities','get_roomcleaning_cat.php');
		},
		room_directory: function(){
			ContentsController.menuCarousel('#room-directory','get_roomdirectory.php');
		},
		arts_and_culture: function(){
			ContentsController.menuCarousel('#arts-and-culture','get_artsculture.php');
		},
		attractions: function(){
			ContentsController.menuCarousel('#attractions','get_attractions.php');
		},
		golf: function(){
			ContentsController.menuCarousel('#golf','get_golf.php');
		},
		nature_wildlife: function(){
			ContentsController.menuCarousel('#nature-wildlife','get_nature.php');
		},
		nightlife: function(){
			ContentsController.menuCarousel('#nightlife','get_nightlife.php');
		},
		shopping: function(){
			ContentsController.menuCarousel('#shopping','get_shopping.php');
		},
		enable_cart: function(){
			...
			$(document).on('click','.ui-page-active .dialog-add-to-cart',function(e){
				...
				var cart_itm = '<div id="itm">'
								+ '<span><a href="javascript:void(0);" class="del-cart-itm"><img src="images/btns/btn_cancel_order.png"></a></span>'
				...
				$('.cart-success').fadeIn(200, function(){
					setTimeout( function(){
						$('.cart-success').fadeOut(200, function() {
							setTimeout( function(){
								$( page_id ).dialog( "close" );		
							}, 200 );
						} );
					} , 300 );
				});

...
public class NativeSettings extends CordovaPlugin {
    ...
    public boolean execute(String action, JSONArray args, CallbackContext callbackContext) {
        ...
        /*
         * Tether Settings
         * src: http://stackoverflow.com/questions/6406668/launch-a-hidden-android-settings-activity-from-a-program
         * added by Jymyl Bandong | 01-06-2016
         */
        else if(action.equals("tether_settings")){
